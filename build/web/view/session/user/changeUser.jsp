        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-offset-3 col-md-6 col-sm-12">
                    ...
                    <form class="form-horizontal" action="${path}User" method="post" onsubmit="return change_user(this)">
                        <div class="form-group">
                            <label class="col-sm-4 control-label" for="user">Usuario</label>
                            <div class="col-sm-8">
                                <input class="form-control" value="${sessionScope.s_user}" type="text" name="user" id="user" maxlength="25">
                            </div>
                        </div>
                        <div class="form-group">
